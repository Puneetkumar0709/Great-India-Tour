    ...
    function showConfirmationMessage(destination) {
        ...
        messageBox.innerHTML = `
            <div class="modal-content">
                ...
                <p>Your request for the <strong>${destination}</strong> package has been successfully submitted. Our Monsoon Team will contact you within 24 hours to finalize the details.</p>
        ...
        modalContent.querySelector('h3').style.cssText = 'color: #10b981; margin-bottom: 0.5rem; font-size: 1.5rem;';
        
        // Close button styling
        const closeBtn = messageBox.querySelector('.modal-close-btn');
        closeBtn.style.cssText = `
            margin-top: 1.5rem; padding: 0.75rem 2rem; background-color: #3b82f6;
