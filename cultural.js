    ...
    function showConfirmationMessage(destination) {
        ...
        messageBox.innerHTML = `
            <div class="modal-content">
                ...
                <p>Your request for the cultural <strong>${destination}</strong> package has been successfully submitted. Our Heritage Specialist will contact you shortly to plan your historical journey.</p>
                <button class="modal-close-btn">Continue Exploring</button>
            </div>
        `;
        ...
        const contentStyle = `
            ...
            max-width: 480px; text-align: center; box-shadow: 0 15px 40px rgba(156, 39, 176, 0.5);
        ...
        modalContent.querySelector('h3').style.cssText = 'color: #9c27b0; margin-bottom: 0.5rem; font-size: 1.8rem; font-weight: 700;';
        ...
        closeBtn.style.cssText = `
            ...
            color: #431096; border: none; border-radius: 0.5rem; cursor: pointer;
